...
- Drive 8: `readyos-v0.2.1-solo-d64-e.d64`
- Host-Side Boot PRG: `readyos-v0.2.1-solo-d64-e-preboot.prg`
- Host-Side Boot PRG: `readyos-v0.2.1-solo-d64-e-boot.prg`
...
- Autostart target: `readyos-v0.2.1-solo-d64-e-preboot.prg`

```sh
x64sc -reu -reusize 16384 -drive8type 1541 -drive8truedrive -devicebackend8 0 +busdevice8 -8 readyos-v0.2.1-solo-d64-e.d64 -autostart readyos-v0.2.1-solo-d64-e-preboot.prg
```
...
- Attach the single disk on drive `8`, then autostart `readyos-v0.2.1-solo-d64-e-preboot.prg` or run `LOAD "PREBOOT",8` then `RUN`.
