...
- Drive 8: `readyos-v0.3.2l-dual-d71_1.d71`
- Drive 9: `readyos-v0.3.2l-dual-d71_2.d71`
- Host-Side Boot PRG: `readyos-v0.3.2l-dual-d71-preboot.prg`
- Host-Side Boot PRG: `readyos-v0.3.2l-dual-d71-boot.prg`
- Host-Side Boot PRG: `readyos-v0.3.2l-dual-d71-setd71.prg`
...
- Configure drive 8 as `1571` with true drive enabled and attach `readyos-v0.3.2l-dual-d71_1.d71`.
- Configure drive 9 as `1571` with true drive enabled and attach `readyos-v0.3.2l-dual-d71_2.d71`.

### VICE Command Example

- Autostart target: `readyos-v0.3.2l-dual-d71-preboot.prg`

```sh
x64sc -reu -reusize 16384 -drive8type 1571 -drive8truedrive -devicebackend8 0 +busdevice8 -8 readyos-v0.3.2l-dual-d71_1.d71 -drive9type 1571 -drive9truedrive -devicebackend9 0 +busdevice9 -9 readyos-v0.3.2l-dual-d71_2.d71 -autostart readyos-v0.3.2l-dual-d71-preboot.prg
```
...
- In VICE, autostart `readyos-v0.3.2l-dual-d71-preboot.prg`, or manually run `LOAD "PREBOOT",8` then `RUN`.
