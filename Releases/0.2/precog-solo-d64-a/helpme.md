...
- Drive 8: `readyos-v0.2v-solo-d64-a.d64`
- Host-Side Boot PRG: `readyos-v0.2v-solo-d64-a-preboot.prg`
- Host-Side Boot PRG: `readyos-v0.2v-solo-d64-a-boot.prg`
...
- Configure drive 8 as `1541` with true drive enabled and attach `readyos-v0.2v-solo-d64-a.d64`.

### VICE Command Example

- Autostart target: `readyos-v0.2v-solo-d64-a-preboot.prg`

```sh
x64sc -reu -reusize 16384 -drive8type 1541 -drive8truedrive -devicebackend8 0 +busdevice8 -8 readyos-v0.2v-solo-d64-a.d64 -autostart readyos-v0.2v-solo-d64-a-preboot.prg
```
...
- Attach the single disk on drive `8`, then autostart `readyos-v0.2v-solo-d64-a-preboot.prg` or run `LOAD "PREBOOT",8` then `RUN`.
