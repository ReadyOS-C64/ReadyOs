...
- Drive 8: `readyos-v0.2.5-dual-d64_1.d64`
- Drive 9: `readyos-v0.2.5-dual-d64_2.d64`
- Host-Side Boot PRG: `readyos-v0.2.5-dual-d64-preboot.prg`
- Host-Side Boot PRG: `readyos-v0.2.5-dual-d64-boot.prg`
...
- Configure drive 8 as `1541` with true drive enabled and attach `readyos-v0.2.5-dual-d64_1.d64`.
- Configure drive 9 as `1541` with true drive enabled and attach `readyos-v0.2.5-dual-d64_2.d64`.

### VICE Command Example

- Autostart target: `readyos-v0.2.5-dual-d64-preboot.prg`

```sh
x64sc -reu -reusize 16384 -drive8type 1541 -drive8truedrive -devicebackend8 0 +busdevice8 -8 readyos-v0.2.5-dual-d64_1.d64 -drive9type 1541 -drive9truedrive -devicebackend9 0 +busdevice9 -9 readyos-v0.2.5-dual-d64_2.d64 -autostart readyos-v0.2.5-dual-d64-preboot.prg
```
...
- Attach all listed disks before boot, then autostart `readyos-v0.2.5-dual-d64-preboot.prg` or run `LOAD "PREBOOT",8` then `RUN`.
