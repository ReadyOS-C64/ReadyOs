...
- Drive 8: `readyos-v0.1.8g-d81.d81`
- Host-Side Boot PRG: `readyos-v0.1.8g-d81-preboot.prg`
- Host-Side Boot PRG: `readyos-v0.1.8g-d81-boot.prg`
...
- Configure drive 8 as `1581` with true drive enabled and attach `readyos-v0.1.8g-d81.d81`.

### VICE Command Example

- Autostart target: `readyos-v0.1.8g-d81-preboot.prg`

```sh
x64sc -reu -reusize 16384 -drive8type 1581 -drive8truedrive -devicebackend8 0 +busdevice8 -8 readyos-v0.1.8g-d81.d81 -autostart readyos-v0.1.8g-d81-preboot.prg
```
...
- Attach the single disk on drive `8`, then autostart `readyos-v0.1.8g-d81-preboot.prg` or run `LOAD "PREBOOT",8` then `RUN`.
