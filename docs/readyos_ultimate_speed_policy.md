...
clock-paced version. Faster CPU control was working; removing the motion-clock
coupling and a hot-path FUNC lookup improved the actual demo substantially.
