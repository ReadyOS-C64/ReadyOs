...
REU_PHYS_PROBE_SRC = $(LIB_DIR)/reu_phys_probe.c
REU_CONTROL_BANK_SRC = $(LIB_DIR)/reu_control_bank.c
REU_CONTROL_REGISTRY_SRC = $(LIB_DIR)/reu_control_registry.c
...
READYSHELL_OVL9_CFLAGS = $(READYSHELL_CCFLAGS) --code-name OVERLAY9 --rodata-name OVERLAY9 --bss-name OVERLAY9
...
READYSHELL_OVL9_PRG = $(BIN_DIR)/rsedit.prg
...
READYSHELL_OVL9_DISK = $(OBJ_DIR)/rsedit.prg
...
READYSHELL_OVERLAY9_SRCS = \
	$(READYSHELL_PLATFORM_C64_DIR)/rs_edit_c64.c
...
READYSHELL_OVERLAY9_OBJS = $(patsubst %.c,$(READYSHELL_OBJ_DIR)/overlay9/%.o,$(READYSHELL_OVERLAY9_SRCS))
...
$(READYSHELL_OBJ_DIR)/overlay9/%.o: %.c
	@mkdir -p "$(dir $@)"
	$(CC) $(READYSHELL_OVL9_CFLAGS) -c -o $@ $<

# ReadyShell app (loads at $1000) + overlay sidecars
$(READYSHELL): $(READYSHELL_RESIDENT_OBJS) $(READYSHELL_OVERLAY1_OBJS) $(READYSHELL_OVERLAY2_OBJS) $(READYSHELL_OVERLAY3_OBJS) $(READYSHELL_OVERLAY4_OBJS) $(READYSHELL_OVERLAY5_OBJS) $(READYSHELL_OVERLAY6_OBJS) $(READYSHELL_OVERLAY7_OBJS) $(READYSHELL_OVERLAY8_OBJS) $(READYSHELL_OVERLAY9_OBJS) $(CFG_DIR)/ready_app_overlay.cfg
	$(CC) -t c64 -C $(CFG_DIR)/ready_app_overlay.cfg \
		...
		$(READYSHELL_RESIDENT_OBJS) $(READYSHELL_OVERLAY1_OBJS) $(READYSHELL_OVERLAY2_OBJS) $(READYSHELL_OVERLAY3_OBJS) $(READYSHELL_OVERLAY4_OBJS) $(READYSHELL_OVERLAY5_OBJS) $(READYSHELL_OVERLAY6_OBJS) $(READYSHELL_OVERLAY7_OBJS) $(READYSHELL_OVERLAY8_OBJS) $(READYSHELL_OVERLAY9_OBJS)
	...
	cp -f $(READYSHELL_OVL9_PRG) $(READYSHELL_OVL9_DISK)

$(READYSHELL_EASYFLASH): $(READYSHELL_RESIDENT_EASYFLASH_OBJS) $(READYSHELL_OVERLAY1_OBJS) $(READYSHELL_OVERLAY2_OBJS) $(READYSHELL_OVERLAY3_OBJS) $(READYSHELL_OVERLAY4_OBJS) $(READYSHELL_OVERLAY5_OBJS) $(READYSHELL_OVERLAY6_OBJS) $(READYSHELL_OVERLAY7_OBJS) $(READYSHELL_OVERLAY8_OBJS) $(READYSHELL_OVERLAY9_OBJS) $(CFG_DIR)/ready_app_overlay.cfg
	$(CC) -t c64 -C $(CFG_DIR)/ready_app_overlay.cfg \
		-Wl -D,__OVERLAYSIZE__=$(READYSHELL_OVERLAYSIZE) \
		-Wl -D,__STACKSIZE__=$(READYSHELL_STACKSIZE) \
		-m $(OBJ_DIR)/readyshell_easyflash.map -o $@ \
		$(READYSHELL_RESIDENT_EASYFLASH_OBJS) $(READYSHELL_OVERLAY1_OBJS) $(READYSHELL_OVERLAY2_OBJS) $(READYSHELL_OVERLAY3_OBJS) $(READYSHELL_OVERLAY4_OBJS) $(READYSHELL_OVERLAY5_OBJS) $(READYSHELL_OVERLAY6_OBJS) $(READYSHELL_OVERLAY7_OBJS) $(READYSHELL_OVERLAY8_OBJS) $(READYSHELL_OVERLAY9_OBJS)
...
clean:
	...
	rm -f $(READYSHELL_OVL1_DISK) $(READYSHELL_OVL2_DISK) $(READYSHELL_OVL3_DISK) \
		...
		$(READYSHELL_OVL7_DISK) $(READYSHELL_OVL8_DISK) $(READYSHELL_OVL9_DISK)
	rm -f *.d64
	rm -f *.d71
	rm -f *.d81
	rm -f *.crt
